...
def create_search_assistant():
    ...
    work_flow.add_node("anwser",generate_answer_node)
    work_flow.add_node("understand",understand_query_node)  
    
    work_flow.add_edge(START,"understand")
    work_flow.add_edge("understand","anwser")
    work_flow.add_edge("anwser",END)
    #编译图
