...
from MyAgent.chapter7.core import Messages
from MyAgent.chapter7.core.Config import Config
...
class SimpleAgent(Agent):
    ...
    def run(self, input_text: str, max_tool_iterations: int = 3, **kwargs) -> str:
        ...
        if not self.enable_tool_calling:
            ...
            self.add_message(Messages(input_text, "user"))
            self.add_message(Messages(response, "assistant"))
            return response
        ...
        # 保存到历史记录
        self.add_message(Messages(input_text, "user"))
        self.add_message(Messages(final_response, "assistant"))
    ...
    def stream_run(self, input_text: str, **kwargs) -> Iterator[str]:
        ...
        # 保存完整对话到历史记录
        self.add_message(Messages(input_text, "user"))
        self.add_message(Messages(full_response, "assistant"))
