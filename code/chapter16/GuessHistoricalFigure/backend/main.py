#!/usr/bin/env python3
"""
Guess Historical Figure Game - FastAPI backend main file
...
app = FastAPI(
    title="猜历史人物游戏API",
    description="基于hello_agents框架的历史人物猜测游戏后端API",
    version="1.0.0"
)
...
async def guess_figure(request: GuessRequest):
    ...
    try:
        ...
        # Make guess
        result = game_session.make_guess(request.guess)
