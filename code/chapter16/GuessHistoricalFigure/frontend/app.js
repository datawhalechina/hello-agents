// Guess Historical Figure Game - Frontend Logic
class GuessHistoricalFigureGame {
  constructor() {
    this.sessionId = null;
  ...
  async submitGuess() {
    ...
    try {
      ...
      if (data.is_correct) {
        ...
        this.endGame(true, data.figure_info);
      } else {
  ...
  async endGame(isWin, figureInfo = null) {
    // Disable controls
    ...
    if (isWin) {
      ...
      resultMessage.textContent = '你成功猜出了历史人物的身份！';
    } else {
      ...
      <div class="welcome-message">
        <div class="message agent-message">
          <div class="message-content">
            你好！我是一位历史人物，你可以通过提问来猜出我的身份。开始吧！
          </div>
        </div>
      </div>`;
  }
...
window.onload = function() {
  window.game = new GuessHistoricalFigureGame();
};