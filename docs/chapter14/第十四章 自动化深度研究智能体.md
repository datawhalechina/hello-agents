...
<div align="center">
  <img src="../images/14-figures/14-1.png" alt="深度研究助手技术架构" width="85%"/>
...
<div align="center">
  <img src="../images/14-figures/14-2.png" alt="深度研究助手数据流转过程" width="85%"/>
...
<div align="center">
  <img src="../images/14-figures/14-3.png" alt="深度研究助手搜索页面" width="85%"/>
...
<div align="center">
  <img src="../images/14-figures/14-4.png" alt="深度研究助手展开研究" width="85%"/>
...
<div align="center">
  <img src="../images/14-figures/14-5.png" alt="TODO驱动的研究流程" width="85%"/>
...
<div align="center">
  ...
  <img src="../images/14-figures/14-table-1.png" alt="三个Agent的职责划分" width="85%"/>
</div>
...
<div align="center">
  <img src="../images/14-figures/14-6.png" alt="Agent协作流程" width="85%"/>
...
<div align="center">
  <p>表 14.2 多搜索引擎对比</p>
  <img src="../images/14-figures/14-table-2.png" alt="多搜索引擎对比" width="85%"/>
</div>
...
<div align="center">
  <img src="../images/14-figures/14-7.png" alt="工具调用流程" width="85%"/>
  <p>图 14.7 工具调用流程</p>
</div>
...
4. <strong>验证子任务格式</strong>：确保每个子任务包含必需的字段（title、intent、query）
...
<div align="center">
  <img src="../images/14-figures/14-8.png" alt="搜索引擎调度流程" width="85%"/>
  <p>图 14.8 搜索引擎调度流程</p>
</div>
...
<div align="center">
  <img src="../images/14-figures/14-9.png" alt="全屏模态对话框UI" width="85%"/>
...
4. <strong>底部栏</strong>：显示状态信息（如"研究中..."、"已完成"）
...
<div align="center">
  <img src="../images/14-figures/14-10.png" alt="SSE流程" width="85%"/>
  <p>图 14.10 SSE 流程</p>
</div>
