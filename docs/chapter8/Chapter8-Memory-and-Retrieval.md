...
result1 = memory_tool.run({
    "action": "add",
    "content": "User Zhang San is a Python developer focusing on machine learning and data analysis",
...
result2 = memory_tool.run({
    "action": "add",
    "content": "Li Si is a frontend engineer skilled in React and Vue.js development",
    "memory_type": "semantic",
    "importance": 0.7
})
