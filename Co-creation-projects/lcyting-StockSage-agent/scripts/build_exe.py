...
def build_exe():
    ...
    pyi_args = [
        ...
        "--hidden-import", "agents.screener_agent",
        "--hidden-import", "agents.sentiment_agent",
        "--hidden-import", "agents.advisor_agent",
        "--hidden-import", "agents.trading_agent",
        "--hidden-import", "agents.preference_injector",
        "--hidden-import", "agents.tools.mx_data_tool",
        "--hidden-import", "agents.tools.mx_search_tool",
        "--hidden-import", "agents.tools.mx_xuangu_tool",
        "--hidden-import", "agents.tools.mx_moni_tool",
        "--hidden-import", "agents.tools.mx_zixuan_tool",
        # 常用依赖
